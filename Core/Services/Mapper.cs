...
namespace Core.Services
{
    ...
    //{
    //    public User ToDomainModel(UserFormDTO userForCreationDTO)
    //    {
    //        User user = new User()
    //        {
    ...
    //    public Table ToDomainModel(TableFormDTO tableForCreationDTO)
    //    {
    ...
    //    public Order ToDomainModel(OrderFormDTO orderForCreationDTO)
    //    {
